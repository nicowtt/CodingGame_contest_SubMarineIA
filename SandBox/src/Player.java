    ...
    public void run() {
        ...
        while (true) {
            ...
            if (opponentMoveSilently) {
                ...
                oppPresenceCell = false; // reset opp presence cell
                countOppPresence = 0;
            }
            ...
            if (compareOppLife == 2) {
                // booelan opp locked
                oppPresenceCell = true;
                // check
                System.err.println("opp life -2 !!!");
            }

            // first lock opponent position on my submarine
            if (oppPresenceCell) {
                // get opponent orders
                String oppMove = locateOpponent.readOpponentMove(mySubmarine.getOpponentOrders());
